...
class WebhookNotifier(AbstractNotifier):
    ...
    def send_notification(self, notification):
        ...
        try:
	    #check to see if box_connector is in the url, if so call the OTE connector script
	    if re.search(r"box_connector", url):
		call(["/home/OTE/seccrit-resilience-reactive.box_connector.sh", json.dumps(body)])
		#call(["/home/OTE/test.sh", json.dumps(body)])
		return True
	    else:
